...
INSERT INTO public."payment"(id, consumer_id, seller_id, product_id, price, subscription_date, expiration_date, payment_due_date)
	VALUES
	(1, 1, 2, 1, 10000, '2022-11-05', '2022-11-11', '2022-11-12'),
	(2, 1, 2, 1, 10000, '2022-11-13', '2022-11-19', '2022-11-20'), 
	(3, 1, 2, 1, 10000, '2022-11-20', '2022-11-26', '2022-11-27'), -- (구독중), (오늘만료) 
	(4, 1, 2, 5, 30000, '2022-11-24', '2022-11-30', '2022-12-01'), -- (구독중), (만료 7일 전)
	(5, 1, 2, 6, 40000, '2022-09-21', '2022-10-20', '2022-10-27'), -- (구독만료)
	(6, 1, 2, 3, 5000, '2022-10-19', '2022-10-20', '2022-10-19'), -- (구독만료)
	(7, 1, 2, 4, 5000, '2022-10-30', '2022-12-01', '2022-12-02'), -- (구독중), (만료 7일 전)
	(8, 1, 2, 7, 25000, '2022-09-28', '2022-10-27', '2022-10-28'),
	(9, 1, 2, 7, 25000, '2022-10-28', '2022-11-27', '2022-11-28'), -- (구독중), (오늘만료)
	(10, 1, 2, 8, 15000, '2022-09-30', '2022-10-29', '2022-10-30'),
	(11, 1, 2, 8, 15000, '2022-10-30', '2022-11-29', '2022-11-30'); -- (구독중), (만료 7일 전)