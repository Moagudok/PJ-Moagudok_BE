...
def CreateProducts():
    Product.objects.bulk_create([
        Product(1, 1, 1, '뉴스 크롤링', 'IT TOP 10', 2, '2022-11-07', '2022-11-07', 10000, \
			...
			5, 2),
        Product(2, 1, 1, '뉴스 크롤링', '정치 TOP 10', 1, '2022-11-08', '2022-11-08', 10000, \
